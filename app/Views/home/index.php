...
<?= $this->section('content') ?>
    ...
    <!-- Hero Section -->
    <section class="hero-section bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 text-white py-20 relative overflow-hidden">
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div class="space-y-6">
                    ...
                    <p class="text-xl md:text-2xl text-gray-200 leading-relaxed">
                        Teknisi berpengalaman 8+ tahun melayani perbaikan laptop, komputer, dan upgrade hardware dengan garansi resmi di Bandung.
                    </p>
                    <div class="flex flex-wrap gap-4 pt-4">
                        <a href="<?= $globalSeo['whatsapp'] ?>" class="bg-green-500 hover:bg-green-600 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300 transform hover:scale-105 shadow-lg">
                            📱 WhatsApp Sekarang
                        </a>
                        <a href="/layanan" class="bg-transparent border-2 border-white hover:bg-white hover:text-blue-900 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300">
                            Lihat Layanan
                        </a>
                    </div>
                ...
                <div class="relative">
                    <img src="/assets/images/hero-laptop-repair.jpg" alt="Service Laptop Bandung Profesional" class="rounded-2xl shadow-2xl w-full" loading="eager">
        ...
        <div class="container mx-auto px-4">
            <div class="text-center mb-16">
                ...
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                    Kami menyediakan berbagai layanan perbaikan dan upgrade untuk laptop dan komputer Anda dengan standar kualitas terbaik.
                </p>
            </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                <?php foreach ($services as $service): ?>
                    <div class="bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 p-8 text-center">
                        ...
                        <a href="/layanan/<?= url_title(strtolower($service['name']), '-', true) ?>" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-semibold transition-colors duration-300 inline-block">
                            Detail Layanan
                        </a>
                    </div>
                <?php endforeach; ?>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="text-center p-8">
                    ...
                    <p class="text-gray-600">Teknisi bersertifikat dengan pengalaman 8+ tahun menangani berbagai merk laptop dan komputer.</p>
                </div>
                ...
                <div class="text-center p-8">
                    ...
                    <p class="text-gray-600">Service laptop Bandung dengan waktu pengerjaan cepat, diagnosis gratis, dan estimasi biaya transparan.</p>
                </div>
                ...
                <div class="text-center p-8">
                    ...
                    <p class="text-gray-600">Semua perbaikan dilengkapi garansi 1-3 bulan untuk memberikan ketenangan pikiran Anda.</p>
                </div>
                ...
                <div class="text-center p-8">
                    ...
                    <p class="text-gray-600">Melayani panggilan ke rumah dan kantor di seluruh area Bandung dengan biaya transportasi minimal.</p>
                </div>
                ...
                <div class="text-center p-8">
                    ...
                    <p class="text-gray-600">Service laptop Bandung dengan harga terjangkau, spare part original, dan tanpa biaya tersembunyi.</p>
                </div>
                ...
                <div class="text-center p-8">
                    ...
                    <p class="text-gray-600">Tim customer service siap membantu Anda kapan saja melalui WhatsApp dan telepon.</p>
                </div>
            </div>
        </div>
    </section>
                ...
                <?php foreach ($testimonials as $testimonial): ?>
                    <div class="bg-white rounded-xl shadow-lg p-8 relative">
                        <div class="flex items-center mb-4">
                            ...
                            <span class="text-sm text-gray-500"><?= $testimonial['service'] ?></span>
                        </div>
    ...
    <section class="py-20 bg-white" id="faq">
        <div class="container mx-auto px-4">
            ...
            <div class="max-w-4xl mx-auto space-y-6">
                <?php foreach ($faqs as $index => $faq): ?>
                    <div class="bg-gray-50 rounded-xl border border-gray-200">
                        <button class="w-full px-8 py-6 text-left flex justify-between items-center hover:bg-gray-100 transition-colors duration-300 rounded-xl" onclick="toggleFAQ(<?= $index ?>)">
                            <h3 class="text-lg font-semibold text-gray-900 pr-4"><?= $faq['question'] ?></h3>
                            <svg id="faq-icon-<?= $index ?>" class="w-6 h-6 text-gray-500 transform transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="text-center mt-12">
                ...
                <a href="/faq" class="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-colors duration-300 inline-block mr-4">
                    Lihat FAQ Lengkap
                </a>
                <a href="/kontak" class="bg-transparent border-2 border-blue-600 hover:bg-blue-600 hover:text-white text-blue-600 px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300 inline-block">
                    Hubungi Kami
                </a>
            </div>
        </div>
        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="text-center max-w-4xl mx-auto">
                ...
                <p class="text-xl md:text-2xl text-gray-200 mb-8 leading-relaxed">
                    Dapatkan diagnosis gratis dan estimasi biaya transparan. Teknisi profesional siap membantu Anda 24/7.
                </p>

                <div class="flex flex-col sm:flex-row gap-6 justify-center items-center mb-12">
                    <a href="tel:<?= $globalSeo['phone'] ?>" class="bg-green-500 hover:bg-green-600 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center">
                        <svg class="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                        </svg>
                        Telepon Sekarang
                    </a>
                    <a href="<?= $globalSeo['whatsapp'] ?>" class="bg-transparent border-2 border-white hover:bg-white hover:text-blue-600 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300 flex items-center">
